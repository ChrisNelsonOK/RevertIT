...
from revertit.timeout.manager import TimeoutEntry, TimeoutManager
...
class TestTimeoutManager(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(
            self.timeout_manager.connectivity_endpoints, ["8.8.8.8", "1.1.1.1"]
        )
    ...
    def test_list_active_timeouts(self):
        ...
        self.timeout_manager.start_timeout(
            change_id="test_456", file_path="/etc/test/config2", change_category="ssh"
        )
