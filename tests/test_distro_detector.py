...
class TestDistroDetector(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = {"auto_detect": True, "force_distro": None}
    ...
    def test_forced_distro(self):
        ...
        config = {"auto_detect": True, "force_distro": "ubuntu"}
    ...
    def test_forced_unknown_distro(self):
        ...
        config = {"auto_detect": True, "force_distro": "unknowndistro"}
        detector = DistroDetector(config)
...
Codename:       focal"""
    ...
    def test_detect_from_system_files(self, mock_file, mock_exists):
        ...
        self.assertEqual(info["version"], "10.0")
        self.assertEqual(info["family"], "debian")
    ...
    def test_is_supported(self):
        ...
        # Mock systemd system
        self.detector._cached_info = {"init_system": "systemd"}

        self.assertTrue(self.detector.is_supported())

        # Mock SysV system
        self.detector._cached_info = {"init_system": "sysv"}

        self.assertTrue(self.detector.is_supported())

        # Mock unknown system
        self.detector._cached_info = {"init_system": "unknown"}
